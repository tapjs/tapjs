...
One example of this strategy is the
...
Subtests can also be nested indefinitely. For example, you might
...
A good way to avoid analysis paralysis is to just do the simplest
