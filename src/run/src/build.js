...
var tmbin = require.resolve('.bin/generate-tap-test-class');
var execArgs = ['--loader=ts-node/esm', '--no-warnings'];
var node = process.execPath;
var build = function (args, config) { return __awaiter(void 0, void 0, void 0, function () {
    var argv;
    return __generator(this, function (_a) {
        if (args.length !== 0) {
            throw new TypeError('build command does not take positional arguments');
        }
        argv = __spreadArray(__spreadArray(__spreadArray([], execArgs, true), [tmbin], false), config.pluginList, true);
        return [2 /*return*/, new Promise(function (res, rej) {
                (0, foreground_child_1.foregroundChild)(node, argv, {}, function (code, signal) {
                    // if this is the main command, just terminate in the same way
                    // otherwise, let the promise communicate the build status
                    if (main_config_js_1.mainCommand === 'build') {
                        res();
                        return;
                    }
                    if (code || signal) {
