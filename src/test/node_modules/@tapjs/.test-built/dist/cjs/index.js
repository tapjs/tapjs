...
const stdin_1 = require("@tapjs/core/plugin/stdin");
const spawn_1 = require("@tapjs/core/plugin/spawn");
const before_1 = require("@tapjs/core/plugin/before");
const before_each_1 = require("@tapjs/core/plugin/before-each");
const after_1 = require("@tapjs/core/plugin/after");
const after_each_1 = require("@tapjs/core/plugin/after-each");
const asserts_1 = require("@tapjs/asserts");
const snapshot_1 = require("@tapjs/snapshot");
const fixture_1 = require("@tapjs/fixture");
const mock_1 = require("@tapjs/mock");
const intercept_1 = require("@tapjs/intercept");
const filter_1 = require("@tapjs/filter");
exports.Plugin_stdin = stdin_1.plugin;
exports.Plugin_spawn = spawn_1.plugin;
exports.Plugin_before = before_1.plugin;
exports.Plugin_beforeEach = before_each_1.plugin;
exports.Plugin_after = after_1.plugin;
exports.Plugin_afterEach = after_each_1.plugin;
exports.Plugin_asserts = asserts_1.plugin;
exports.Plugin_snapshot = snapshot_1.plugin;
exports.Plugin_fixture = fixture_1.plugin;
exports.Plugin_mock = mock_1.plugin;
exports.Plugin_intercept = intercept_1.plugin;
exports.Plugin_filter = filter_1.plugin;
const plugins = [
