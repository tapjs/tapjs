...
exports.Test = exports.signature = exports.loaders = exports.config = exports.pluginsLoaded = exports.Plugin_stdin = exports.Plugin_spawn = exports.Plugin_snapshot = exports.Plugin_mock = exports.Plugin_intercept = exports.Plugin_fixture = exports.Plugin_filter = exports.Plugin_typescript = exports.Plugin_beforeEach = exports.Plugin_before = exports.Plugin_afterEach = exports.Plugin_after = exports.Plugin_asserts = void 0;
...
const _Plugin_typescript = __importStar(require("@tapjs/core/plugin/typescript"));
...
const _Plugin_spawn = __importStar(require("@tapjs/spawn"));
const _Plugin_stdin = __importStar(require("@tapjs/stdin"));
...
exports.Plugin_typescript = _Plugin_typescript.plugin;
...
exports.pluginsLoaded = new Map([
    ...
    ['typescript', exports.Plugin_typescript],
...
const config = (jack) => {
    const config_0 = _Plugin_typescript.config["typecheck"];
    if (!(0, jackspeak_1.isConfigOption)(config_0, "boolean", false)) {
        throw new Error("Invalid config option \"typecheck\" defined in plugin: @tapjs/core/plugin/typescript");
    }
    const config_1 = _Plugin_filter.config["only"];
    if (!(0, jackspeak_1.isConfigOption)(config_1, "boolean", false)) {
        throw new Error("Invalid config option \"only\" defined in plugin: @tapjs/filter");
    }
    const config_2 = _Plugin_filter.config["grep"];
    if (!(0, jackspeak_1.isConfigOption)(config_2, "string", true)) {
        throw new Error("Invalid config option \"grep\" defined in plugin: @tapjs/filter");
    }
    const config_3 = _Plugin_filter.config["invert"];
    ...
    const config_4 = _Plugin_filter.config["no-invert"];
    ...
    const config_5 = _Plugin_fixture.config["save-fixture"];
    ...
    const config_6 = _Plugin_snapshot.config["snapshot"];
    if (!(0, jackspeak_1.isConfigOption)(config_6, "boolean", false)) {
        throw new Error("Invalid config option \"snapshot\" defined in plugin: @tapjs/snapshot");
    }
    return jack
        .heading("From plugin: @tapjs/core/plugin/typescript")
        .flag({ ["typecheck"]: config_0 })
        .heading("From plugin: @tapjs/filter")
        .flag({ ["only"]: config_1 })
        .optList({ ["grep"]: config_2 })
        .flag({ ["invert"]: config_3 })
        .flag({ ["no-invert"]: config_4 })
        .heading("From plugin: @tapjs/fixture")
        .flag({ ["save-fixture"]: config_5 })
        .heading("From plugin: @tapjs/snapshot")
        .flag({ ["snapshot"]: config_6 });
};
