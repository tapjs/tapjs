...
export declare const Plugin_filter: (t: TestBase, opts: _Plugin_filter.FilterOptions) => {
    "__#13@#private": any;
    only(name: string, extra: TestOpts, cb: (t: Test) => any): Promise<import("tap-parser").FinalResults | null>;
    only(name: string, cb: (t: Test) => any): Promise<import("tap-parser").FinalResults | null>;
    only(extra: TestOpts, cb: (t: Test) => any): Promise<import("tap-parser").FinalResults | null>;
    only(cb: (t: Test) => any): Promise<import("tap-parser").FinalResults | null>;
};
