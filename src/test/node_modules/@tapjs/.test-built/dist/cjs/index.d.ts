...
export declare const Plugin_intercept: (t: TestBase) => import("@tapjs/intercept").Interceptor;
export declare const Plugin_filter: (t: TestBase, opts: import("@tapjs/filter").FilterOptions) => {
    "__#16@#private": any;
    only(name: string, extra: TestOpts, cb: (t: Test) => any): Promise<FinalResults | null>;
...
export type TestOpts = TestBaseOpts & Plugin_stdin_Opts & Plugin_spawn_Opts & Plugin_before_Opts & Plugin_beforeEach_Opts & Plugin_after_Opts & Plugin_afterEach_Opts & Plugin_asserts_Opts & Plugin_snapshot_Opts & Plugin_fixture_Opts & Plugin_mock_Opts & Plugin_intercept_Opts & Plugin_filter_Opts;
