...
export interface Test<Ext extends BuiltPlugins = BuiltPlugins> extends TTest {
...
export declare class Test<Ext extends BuiltPlugins = BuiltPlugins> extends TestBase {
