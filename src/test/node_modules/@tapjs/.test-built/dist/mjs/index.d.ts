...
export declare const Plugin_filter: (t: TestBase, opts: _Plugin_filter.FilterOptions) => {
    "__#5@#private": any;
    only(name: string, extra: import("@tapjs/.test-built").TestOpts, cb: (t: import("@tapjs/.test-built").Test) => any): Promise<import("tap-parser").FinalResults | null>;
    only(name: string, cb: (t: import("@tapjs/.test-built").Test) => any): Promise<import("tap-parser").FinalResults | null>;
    only(extra: import("@tapjs/.test-built").TestOpts, cb: (t: import("@tapjs/.test-built").Test) => any): Promise<import("tap-parser").FinalResults | null>;
    only(cb: (t: import("@tapjs/.test-built").Test) => any): Promise<import("tap-parser").FinalResults | null>;
};
...
export declare const Plugin_spawn: (t: TestBase) => {
    "__#10@#private": any;
    spawn(cmd: string): _Plugin_spawn.PromiseWithSpawn;
    spawn(cmd: string, options: _Plugin_spawn.SpawnOpts, name?: string | undefined): _Plugin_spawn.PromiseWithSpawn;
    spawn(cmd: string, args: string | string[], name?: string | undefined): _Plugin_spawn.PromiseWithSpawn;
    spawn(cmd: string, args: string | string[], options: _Plugin_spawn.SpawnOpts, name?: string | undefined): _Plugin_spawn.PromiseWithSpawn;
};
export declare const Plugin_stdin: (t: TestBase) => {
    "__#11@#private": any;
    stdin(name: string, extra?: import("@tapjs/core").StdinOpts | undefined): _Plugin_stdin.PromiseWithStdin;
    stdin(extra?: import("@tapjs/core").StdinOpts | undefined): Promise<import("tap-parser").FinalResults | null>;
};
...
type Plug = TestBase | {
    t: Test;
} | ReturnType<typeof Plugin_asserts> | ReturnType<typeof Plugin_after> | ReturnType<typeof Plugin_afterEach> | ReturnType<typeof Plugin_before> | ReturnType<typeof Plugin_beforeEach> | ReturnType<typeof Plugin_typescript> | ReturnType<typeof Plugin_filter> | ReturnType<typeof Plugin_fixture> | ReturnType<typeof Plugin_intercept> | ReturnType<typeof Plugin_mock> | ReturnType<typeof Plugin_snapshot> | ReturnType<typeof Plugin_spawn> | ReturnType<typeof Plugin_stdin>;
...
export type TestOpts = TestBaseOpts & Plugin_asserts_Opts & Plugin_after_Opts & Plugin_afterEach_Opts & Plugin_before_Opts & Plugin_beforeEach_Opts & Plugin_typescript_Opts & Plugin_filter_Opts & Plugin_fixture_Opts & Plugin_intercept_Opts & Plugin_mock_Opts & Plugin_snapshot_Opts & Plugin_spawn_Opts & Plugin_stdin_Opts;
type TTest = TestBase & ReturnType<typeof Plugin_asserts> & ReturnType<typeof Plugin_after> & ReturnType<typeof Plugin_afterEach> & ReturnType<typeof Plugin_before> & ReturnType<typeof Plugin_beforeEach> & ReturnType<typeof Plugin_typescript> & ReturnType<typeof Plugin_filter> & ReturnType<typeof Plugin_fixture> & ReturnType<typeof Plugin_intercept> & ReturnType<typeof Plugin_mock> & ReturnType<typeof Plugin_snapshot> & ReturnType<typeof Plugin_spawn> & ReturnType<typeof Plugin_stdin>;
