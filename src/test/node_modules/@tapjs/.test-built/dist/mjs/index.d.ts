...
export interface Test<Ext extends BuiltPlugins = BuiltPlugins, Opts extends TestOpts = TestOpts> extends TTest {
    ...
    test(name: string, cb?: (t: Test<Ext, Opts> & Ext) => any): PromiseWithSubtest<Test<Ext, Opts>>;
    ...
    test(...args: TestArgs<Test<Ext, Opts> & Ext>): PromiseWithSubtest<Test<Ext, Opts> & Ext>;
    ...
    todo(...args: TestArgs<Test<Ext, Opts> & Ext, Opts>): PromiseWithSubtest<Test<Ext, Opts> & Ext>;
    ...
    skip(...args: TestArgs<Test<Ext, Opts> & Ext, Opts>): PromiseWithSubtest<Test<Ext, Opts> & Ext>;
...
export declare class Test<Ext extends BuiltPlugins = BuiltPlugins, Opts extends TestOpts = TestOpts> extends TestBase {
    #private;
