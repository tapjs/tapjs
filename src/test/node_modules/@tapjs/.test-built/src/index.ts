...
export const Plugin_typescript = _Plugin_typescript.plugin
...
type Plug =
  ...
  | ReturnType<typeof Plugin_typescript>
...
type PlugKeys =
  ...
  | keyof ReturnType<typeof Plugin_typescript>
...
export const config = <C extends ConfigSet>(jack: Jack<C>) => {
  ...
  if (!isConfigOption(config_6, "boolean", false)) {
...
>
export type Plugin_typescript_Opts = SecondParam<
  Parameters<typeof Plugin_typescript>
>
