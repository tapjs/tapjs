 ...
 */
'use strict'
exports[`test/parser.ts TAP subtest-no-comment-mid-comment.tap > output bail=false 1`] = `
Array [
  Array [
    "line",
    "TAP version 13\\n",
...
exports[`test/parser.ts TAP subtest-no-comment-mid-comment.tap > output bail=true 1`] = `
Array [
  Array [
    "line",
    "TAP version 13\\n",
