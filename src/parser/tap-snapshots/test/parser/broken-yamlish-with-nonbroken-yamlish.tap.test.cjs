...
'use strict'
exports[
  `test/parser.ts > TAP > broken-yamlish-with-nonbroken-yamlish.tap > output bail=false 1`
] = `
Array [
  Array [
    "line",
...
exports[
  `test/parser.ts > TAP > broken-yamlish-with-nonbroken-yamlish.tap > output bail=true 1`
] = `
Array [
  Array [
    "line",
