...
'use strict'
exports[
  `test/parser.ts > TAP > buffered-nested-ok-top-failure-diag.tap > output bail=false 1`
] = `
Array [
  Array [
    "line",
...
exports[
  `test/parser.ts > TAP > buffered-nested-ok-top-failure-diag.tap > output bail=true 1`
] = `
Array [
  Array [
    "line",
