...
exports[`test/test-point.ts > TAP > ok=false > failSkip and skip:msg 1`] = `
TestPoint {
  "extra": Object {
    "failedSkip": "msg",
    "failSkip": true,
...
exports[`test/test-point.ts > TAP > ok=false > failSkip and skip:true 1`] = `
TestPoint {
  "extra": Object {
    "failedSkip": true,
    "failSkip": true,
...
exports[`test/test-point.ts > TAP > ok=false > failTodo and todo:msg 1`] = `
TestPoint {
  "extra": Object {
    "failedTodo": "msg",
    "failTodo": true,
...
exports[`test/test-point.ts > TAP > ok=false > failTodo and todo:true 1`] = `
TestPoint {
  "extra": Object {
    "failedTodo": true,
    "failTodo": true,
...
exports[`test/test-point.ts > TAP > ok=true > failSkip and skip:msg 1`] = `
TestPoint {
  "extra": Object {
    "failedSkip": "msg",
    "failSkip": true,
...
exports[`test/test-point.ts > TAP > ok=true > failSkip and skip:true 1`] = `
TestPoint {
  "extra": Object {
    "failedSkip": true,
    "failSkip": true,
...
exports[`test/test-point.ts > TAP > ok=true > failTodo and todo:msg 1`] = `
TestPoint {
  "extra": Object {
    "failedTodo": "msg",
    "failTodo": true,
...
exports[`test/test-point.ts > TAP > ok=true > failTodo and todo:true 1`] = `
TestPoint {
  "extra": Object {
    "failedTodo": true,
    "failTodo": true,
