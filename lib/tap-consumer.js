...
TapConsumer.prototype.end = function () {
  ...
  if (!this.bailed && this._planEnd && this._actualCount !== this._planEnd) {
    this.emit("data", {ok: false, name: "test count did not match plan"
                      ,found:this._actualCount
                      ,wanted:this._planEnd})
  }
...
TapConsumer.prototype._parseResultLine = function (line) {
  this._actualCount ++
  if (this._sawPlan) {
    this.emit("data", {ok: false, name:"test after plan line"
