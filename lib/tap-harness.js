...
Harness.prototype.end = function () {
  ...
  if (this._ended && !this._bailedOut) {
  ...
  if (this._plan !== null && !this._bailedOut) {
  ...
  if (cb) {
    ...
    t.on("ready", function () {
      if (!isNaN(conf.timeout) && isFinite(conf.timeout)) {
        ...
        // can't listen to the "bailout" event, since that
...
Harness.prototype.bailout = function (message) {
  ...
  if (this._current) this.childEnd(this._current)
