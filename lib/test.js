...
function getBufferedOption (self, extra) {
  if (extra.buffered === true) {
    return true
...
Test.prototype.test = function test (name, extra, cb, deferred) {
  ...
  extra.buffered = getBufferedOption(this, extra)
...
function reportTimeout (stream, parser, extra, ind) {
  ...
  extra = cleanYamlObject(extra, yamlFilter)
