...
// parasitic
Test.prototype.ok = function (cond, name, conf) {
  this.result(assert.ok(cond, name, conf))
}

Test.prototype.equal = function (got, wanted, name, conf) {
  this.result(assert.equal(got, wanted, name, conf))
}
