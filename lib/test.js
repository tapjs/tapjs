...
class Test extends Base {
  ...
  thread (file, args, options, name) {
    ...
    return this.sub(Thread, options, Test.prototype.thread)
  }

  require (file, options, name) {
    if (typeof options === 'string')
      name = options, options = null

    const opt = Object.assign({}, options || {}, { autoend: true })
    this.test(name, opt, t => {
      requireInject(path.resolve(file), {
        tap: t,
        [require.resolve('../')]: t,
      })
    })
